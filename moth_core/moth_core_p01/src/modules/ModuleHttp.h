...
const String CSV_HEAD = FIELD_NAME____TIME + SEMICOLON + FIELD_NAME___PM010 + SEMICOLON + FIELD_NAME___PM025 + SEMICOLON + FIELD_NAME___PM100 + SEMICOLON + FIELD_NAME_____DEG + SEMICOLON + FIELD_NAME_____HUM + SEMICOLON + FIELD_NAME_____HPA + "\r\n";
const String CSV_FRMT = "%04d-%02d-%02d %02d:%02d:%02d;%3d;%3d;%3d;%5.1f;%4.1f;%7.2f\r\n";
const uint8_t CSV_LINE_LENGTH = 52;
