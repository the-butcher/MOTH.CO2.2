...
public:
  ThinkInk_290_Grayscale4_T5_Clone(int16_t SID, int16_t SCLK, int16_t DC, int16_t RST,
                             int16_t CS, int16_t SRCS, int16_t MISO,
                             int16_t BUSY = -1)
      : Adafruit_IL0373(296, 128, SID, SCLK, DC, RST, CS, SRCS, MISO, BUSY){};

  ThinkInk_290_Grayscale4_T5_Clone(int16_t DC, int16_t RST, int16_t CS, int16_t SRCS,
