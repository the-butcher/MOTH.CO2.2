#ifndef ModuleDispBase_h
#define ModuleDispBase_h
...
class ModuleDispBase : public Adafruit_IL0373 {
   public:
    ModuleDispBase() : Adafruit_IL0373(296, 128, PIN_EPD_DC, PIN_EPD_RESET, PIN_EPD_CS, PIN_SRAM_CS, PIN_EPD_BUSY){};

    ModuleDispBase(int16_t SID, int16_t SCLK, int16_t DC, int16_t RST, int16_t CS, int16_t SRCS, int16_t MISO, int16_t BUSY = -1) : Adafruit_IL0373(296, 128, SID, SCLK, DC, RST, CS, SRCS, MISO, BUSY){};

    ModuleDispBase(int16_t DC, int16_t RST, int16_t CS, int16_t SRCS, int16_t BUSY = -1, SPIClass *spi = &SPI) : Adafruit_IL0373(296, 128, DC, RST, CS, SRCS, BUSY, spi){};
