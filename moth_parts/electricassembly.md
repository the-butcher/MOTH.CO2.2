...
3d-print [STL "supports"](supports.stl), clean printed parts with a file or sandpaper, cleanup holes with a 2mm drill if required. Use 4 M2 x 5mm screws and 4 M2 nuts to connect the feather esp32-s2 microcontroller and the scd-41 sensor. Try not to touch the CO₂ sensors central part to avoid contamination. Connect microcontroller and scd-41 sensor with the Stemma QT cable (not pictured).
